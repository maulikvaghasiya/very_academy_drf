...
class Product(models.Model):
    ...
    product_attribute = models.ManyToManyField(ProductAttributeValue)
...
class ProductInventory(models.Model):
    ...
    retail_price = models.DecimalField(
        ...
        error_messages={
            "name": {
                "max-length": _("the price must be between 0 and 999.99."),
            }
        },
    )
    ...
    sale_price = models.DecimalField(
        max_digits=5,
        decimal_places=2,
        verbose_name=_("regular sale price"),
        help_text=_("format : maximum price 999.99"),
        error_messages={
            "name": {
                "max-length": _("the price must be between 0 and 999.99."),
...
class Media(models.Model):
    ...
    is_feature = models.BooleanField(
        default=False,
        verbose_name=_("product_visiblity"),
...
class Stock(models.Model):
    ...
    units_sold = models.IntegerField(
        default=0,
        verbose_name=_("units sold quantity"),
    )
